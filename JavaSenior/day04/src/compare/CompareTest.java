...
/**
 * 一、说明：Java中的对象，正常情况下，只能进行比较：== 或 ！=，不能使用 > 或 < 的，但是在开发
 * 场景中，我们需要对多个对象进行排序，言外之意，就需要比较对象的大小，如何实现？使用两个接口中的
 * 任何一个：Comparable 或 Comparator
 *
...
public class CompareTest
{
    /*
    Comparable接口的使用举例：
    1.像String，包装类等实现了Comparable接口，重写了compareTo()方法，给出了比较两个对象大小的
    方式
    ...
    public void test1()
    {
        ...
        arr[1] = new Goods("dell",43.0);
        arr[2] = new Goods("xiaomi",12.0);
        arr[3] = new Goods("huawei",65.0);
        arr[4] = new Goods("microsoft",43.0);
        Arrays.sort(arr);
   ...
   接口的排序规则不适合当前的操作那么可以考虑使用Comparator的对象来排序
...
//                return 0;
    ...
    public void test3()
    {
        ...
        arr[2] = new Goods("xiaomi",12.0);
        arr[3] = new Goods("huawei",65.0);
        arr[4] = new Goods("dicrosoft",40.0);
