...
import com.atck.dao.DepartmentMapper;
...
public class MapperTest
{
    ...
    public void testCRUD()
    {
        ...
        //2.生成员工数据
        // employeeMapper.insertSelective(new Employee(null,"Jerry","M","Jerry@atck.com",1));
        ...
        for (int i = 0; i < 1000; i++)
        {
            ...
            mapper.insertSelective(new Employee(null,uid,"M",uid + "@atck.com",1));
        }
